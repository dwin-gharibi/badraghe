...
export default function ReservationStatsTable() {
  ...
  useEffect(() => {
    const fetchReservationStats = async () => {
      ...
      try {
        ...
        setError(err.message || 'Failed to fetch reservation stats');
        toast({
          title: 'Error',
          description: err.message || 'Failed to fetch reservation stats',
          status: 'error',
          duration: 5000,
          isClosable: true,
        });
