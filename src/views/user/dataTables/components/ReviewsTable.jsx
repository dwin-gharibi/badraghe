...
export default function ReviewsTable() {
  ...
  const columns = [
    ...
    columnHelper.accessor('rating', {
      id: 'rating',
      header: () => <Text justifyContent="space-between" align="center" fontSize={{ sm: '10px', lg: '12px' }} color="gray.400">RATING</Text>,
      cell: (info) => <Text color={textColor} fontSize="sm" fontWeight="700">{info.getValue()}</Text>,
    }),
    columnHelper.accessor('review_text', {
      id: 'review_text',
      header: () => <Text justifyContent="space-between" align="center" fontSize={{ sm: '10px', lg: '12px' }} color="gray.400">REVIEW</Text>,
      ...
      cell: (info) => (
        <Stack direction="row" spacing={2}>
          <IconButton
            ...
            colorScheme="blue"
            aria-label="View"
            onClick={() => console.log('View review', info.row.original.id)}
          />
          <IconButton
            icon={<FaEdit />}
            colorScheme="yellow"
            aria-label="Edit"
            onClick={() => console.log('Edit review', info.row.original.id)}
          />
          <IconButton
            icon={<FaTrash />}
            colorScheme="red"
            aria-label="Delete"
            onClick={() => console.log('Delete review', info.row.original.id)}
          />
        </Stack>
      ),
    }),
